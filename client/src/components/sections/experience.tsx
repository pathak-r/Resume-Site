    ...
    <section id="experience" className="py-24 bg-background">
      <div className="container px-6 mx-auto">
        <motion.div
          ...
          className="mb-12"
        >
          <h2 className="text-3xl font-bold font-heading mb-4 text-foreground">Experience</h2>
        </motion.div>
          ...
          {experiences.map((exp, index) => (
            ...
            >
              ...
              <div className="flex flex-col md:flex-row md:items-baseline justify-between mb-2 gap-2">
                <h3 className="text-xl font-bold font-heading text-foreground">{exp.role}</h3>
                <span className="text-sm font-bold text-muted-foreground">{exp.period}</span>
              </div>
              
              <div className="mb-4">
                <div className="text-base font-bold text-foreground mb-1">{exp.company}</div>
                <div className="text-xs text-muted-foreground">{exp.location}</div>
              </div>

              <p className="text-base text-foreground mb-4 font-medium">{exp.description}</p>
