            ...
            <Link href="/geo-agentic-int" data-testid="card-geo-feature">
              ...
              >
                ...
                <div className="flex items-center justify-between mb-5">
                  <span className="chip-teal flex items-center gap-2" style={{ fontSize: '0.95rem', fontWeight: 800, letterSpacing: '0.02em', padding: '0.45rem 1rem' }}>
                    <span
                      className="inline-block w-2 h-2 rounded-full"
                      style={{ background: '#0ac4fd', boxShadow: '0 0 10px #0ac4fd' }}
                    />
